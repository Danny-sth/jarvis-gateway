...
HTTP gateway для приёма webhooks и голосового API. Отправляет уведомления через Jarvis.
...
- `JARVIS_URL` - URL Jarvis API (default: http://localhost:8081)
